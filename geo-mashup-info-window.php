...
<?php if (have_posts()) : ?>
	...
	<div class='map-post-summary'>
		...
		if ('attachment' == $post->post_type) :
			echo "<div class='attachment-image-container'>";
			echo wp_get_attachment_image( $post->ID, 'post-thumbnail');
			echo "</div>";
		endif;
		...
		<?php endif; ?>
		<a class='map-post-permalink' href='<?php echo get_permalink();?>'>View &raquo;</a>
	</div><!--.map-post-summary-->
	<?php endwhile; ?>
